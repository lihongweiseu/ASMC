...
ylim([-30,-10]);
ylabel('Delay~(msec)','fontsize',13,'interpreter','latex');
xlabel('Frequency~(Hz)','fontsize',13,'interpreter','latex');
legend({'Original model','Reduced model'},...
    'fontsize',13,'interpreter','latex','location','Southeast');
